...
export class ViewPonudjaciComponent implements OnInit {
  ...
  constructor(protected viewPonudjaciService: ViewPonudjaciService, protected activatedRoute: ActivatedRoute, public router: Router) {}
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.viewPonudjacis = dataFromBody;
  }
